    ...
    <div className="min-h-screen bg-[#0e0e0e] text-white p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 text-gray-400 leading-relaxed">
          ...
          <p><strong className="text-white">۱. نظرات و اسپویلرها:</strong> کاربران موظف هستند در صورت لو دادن داستان فیلم یا سریال، تیک «حاوی اسپویلر» را فعال کنند. عدم رعایت این مورد可能导致 حذف نظر یا مسدود شدن حساب کاربری.</p>
