    ...
    <div className="min-h-screen bg-[#0e0e0e] text-white p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 text-gray-400 leading-relaxed">
          <p>استفاده از سایت FilmTrack به معنی پذیرفتن قوانین زیر است:</p>
          ...
          <p><strong className="text-white">۳. محتوای غیرقانونی:</strong> FilmTrack یک پلتفرم ردیابی و نقد است. لینک دانلود غیرقانونی فیلم‌ها در این پلتفرم اکیداً ممنوع است.</p>
